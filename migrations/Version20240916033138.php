 ...
 */
final class Version20240916033138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IF NOT EXISTS DX_2E699867A76ED395 ON work_shop_user (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE work_shop_user DROP CONSTRAINT work_shop_user__work_showp_id__work_shop__id_fk');
        $this->addSql('ALTER TABLE work_shop_user DROP CONSTRAINT work_shop_user__user_id__user__id_fk');
