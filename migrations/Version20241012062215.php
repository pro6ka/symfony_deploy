 ...
 */
final class Version20241012062215 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE work_shop_user DROP CONSTRAINT IF EXISTS work_shop_user__work_shop_id__work_shop__id_fk');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE work_shop_user ADD CONSTRAINT work_shop_user__work_shop_id__work_shop__id_fk FOREIGN KEY (work_shop_id) REFERENCES work_shop (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
